...
This will automatically download and install Areboot on your system. Make sure you have `curl` installed and run the command with root privileges.
...
### **Support**
If you encounter any issues or have questions, feel free to open an issue on the [GitHub repository](https://github.com/Salarvand-Education/Areboot).
